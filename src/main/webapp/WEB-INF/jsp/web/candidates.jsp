                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                            ...
                                                            <ul>
                                                                <li><i class="fa fa-cc-paypal"></i>&nbsp;${candidate.salaryMin} - ${candidate.salaryMax}</li>
                                                                <li><i class="fa fa-map-marker"></i>&nbsp; ${candidate.address.country.name}&nbsp; ${candidate.address.city.name}</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                            <ul>
                                                                ...
                                                                <li><a href="candidate?id=${candidate.id}">View</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
...
<!-- Mirrored from www.webstrot.com/html/jobpro/job_light/candidate_listing.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Sep 2019 12:39:38 GMT -->
</html>
