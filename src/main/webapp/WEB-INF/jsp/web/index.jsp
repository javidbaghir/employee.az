                    ...
                    <div class="item">
                        <div class="jp_tittle_slides_one">
                            ...
                            <div class="jp_tittle_side_cont_wrapper">
                                <h4>Graphic Designeriiii (UI / UX)</h4>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="cc_featured_product_main_wrapper">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#best" aria-controls="best" role="tab" data-toggle="tab">Recent Jobs</a></li>>
                            </ul>
                        </div>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="best">
                                ...
                                <div class="ss_featured_products">
                                        ...
                                        <c:forEach items="${recentJob}" var="job">
