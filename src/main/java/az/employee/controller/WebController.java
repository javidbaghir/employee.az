...
public class WebController {
    ...
    @Autowired
    private EmployeeazConfiguration configration;
...
//    }
    ...
    public ModelAndView index() {
        ...
        System.out.println("configration = " + configration);
        ModelAndView modelAndView = new ModelAndView("web/index");

        modelAndView.addObject("jobCount", jobService.getAllJobCount());
        modelAndView.addObject("jobCategoryCountList", jobService.getJobCategoryCount());
        modelAndView.addObject("recentJobList", jobService.getRecentJobList());
...
//    }
    ...
    public ModelAndView candidates(
        ...
        long pageCount = candidateService.getPageCount();
